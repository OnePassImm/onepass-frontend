...
export const LIST_PROGRAM_INFO: TProgramInfo[] = [
	{
		...
		listContent: [
			...
			plain("Thanh toán khi nộp hồ sơ đăng ký tham gia chương trình (Trường hợp khách hàng từ chối tiếp tục chương trình sau khi nhận được visa, không hoàn trả bất cứ khoản phí đã đặt cọc từ phí khách hàng)."),
			...
			listItem("Chương trình học tiếng Anh (ESL) hàng ngày."),
			listItem("Tham quan các điểm du lịch."),
			listItem("Hoạt động ngoại khoá với học sinh quốc tế."),
			listItem("Tiệc chia tay và đưa đón sân bay."),
			listItem("BHYT và BHTN."),
			listItem("Phí giám hộ (bắt buộc với HS dưới 18 tuổi)."),
			...
			link("/contents/program/summerCamp/CHƯƠNG TRÌNH TRẠI HÈ.pdf", "CHƯƠNG TRÌNH TRẠI HÈ.pdf"),
	...
	},
	{
		...
		listContent: [
			...
			plain("Tuỳ theo hồ sơ của mỗi người, OnePass sẽ sắp xếp hồ sơ theo lộ trình phù hợp nhất với khách hàng của công ty."),
			...
			space,
			bold("Thông tin chi tiết:"),
			link("/contents/program/tourism/DU LỊCH CANADA.pdf", "DU LỊCH CANADA.pdf"),
			link("/contents/program/tourism/DU LỊCH CANADA.docx", "DU LỊCH CANADA.docx"),
		],
	},
	{
		id: "settled",
		...
		listContent: [
			...
			space,
			bold("Thông tin chi tiết:"),
			link("/contents/program/settled/CHƯƠNG TRÌNH ĐỊNH CƯ.pdf", "CHƯƠNG TRÌNH ĐỊNH CƯ.pdf"),
	...
	},
	{
		...
		listContent: [
			...
			space,
			bold("Thông tin chi tiết:"),
			link("/contents/program/studyAbroad/CHƯƠNG TRÌNH DU HỌC.pdf", "CHƯƠNG TRÌNH DU HỌC.pdf"),
	...
	},
	{
		...
		listContent: [
			...
			space,
			bold("Thông tin chi tiết:"),
			link("/contents/program/pathway/CHƯƠNG TRÌNH PATHWAY.pdf", "CHƯƠNG TRÌNH PATHWAY.pdf"),
